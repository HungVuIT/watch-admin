...
export default {
    login: ({ username, password }) => {
        if (username === 'admin' && password === 'admin') {
            ...
            localStorage.setItem('user', 'Lê Tiến Dũng');
            localStorage.setItem('auth', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidXNlcm5hbWUiOiJhZG1pbkBnbWFpbC5jb20iLCJpYXQiOjE2ODY0OTExNDAsImV4cCI6MTcxODA0ODc0MH0.IKy3P0ix_IpJ7S60iGK1yvjnfjgVKYvBj1L0V9qu8wU');
